...
function smarty_function_online_now( $params, $smarty )
{
    ...
    $buttonMarkup = '<div class="ow_miniic_live">'. $spanOnline . $chatNowMarkup . '</div>';
