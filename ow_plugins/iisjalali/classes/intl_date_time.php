...
class IISJALALI_CLASS_IntlDateTime extends \DateTime {
...
public function jdate_words($array,$mod=''){
 ...
 foreach($array as $type=>$num){
  ...
  switch($type){
	...
	case'mm':
	$key=array
	(OW::getLanguage()->text('iisjalali', 'date_time_month_short_fa_1'),OW::getLanguage()->text('iisjalali', 'date_time_month_short_fa_2')
