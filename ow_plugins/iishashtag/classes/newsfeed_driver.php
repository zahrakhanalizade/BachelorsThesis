 ...
 * @since 1.0
 */
class IISHASHTAG_CLASS_NewsfeedDriver extends NEWSFEED_CLASS_Driver
{
    ...
    public function findByUser( $userId, $includeIdList = array(), $hashtag, $limit = null, $startTime = null, $formats = null, $driver = null )
    {
        ...
        $dashboardQuery = ' SELECT  b.`id` FROM
            ( 
            '.$siteFeedQuery.' 
        ...
        $idList = array_unique(OW::getDbo()->queryForColumnList($dashboardQuery, array(
