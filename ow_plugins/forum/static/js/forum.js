var ForumCustomize = {
	...
	construct: function()
	{
		...
		$('.forum_section_tr').hover( 
			function(){
				$(this).find('.ow_section_acts').css("visibility", "visible");
			}, 
			function(){
				$(this).find('.ow_section_acts').css("visibility", "hidden");
			}
		);
		
		$('.forum_group').hover( 
				function(){
					$(this).find('.ow_group_acts').css("visibility", "visible");
				}, 
				function(){
					$(this).find('.ow_group_acts').css("visibility", "hidden");
				}
			);		
