 ...
 * @since 1.0
 */
class IISPASSWORDCHANGEINTERVAL_MCTRL_Iispasswordchangeinterval extends OW_ActionController
{
    private $service;
    ...
    public function index($params = NULL)
    {
        ...
        if ($passwordValidation != null && !$passwordValidation->valid) {
            ...
            if ($this->service->isTokenExpired($passwordValidation->tokentime)) {
                ...
                $this->assign('resendEmailChangePasswordUrl', OW::getRouter()->urlForRoute('iispasswordchangeinterval.resend-link'));
            }
            ...
            if($passwordValidation!=null){
                ...
                $this->service->updateTimePasswordChanged();
            }
