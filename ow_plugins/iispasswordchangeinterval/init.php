...
OW::getRouter()->addRoute(new OW_Route('iispasswordchangeinterval.admin.invalidate-password', 'iispasswordchangeinterval/admin/invalidatepassword/:username/:sectionId', 'IISPASSWORDCHANGEINTERVAL_CTRL_Admin', 'invalidatePassword'));
...
OW::getRouter()->addRoute(new OW_Route('iispasswordchangeinterval.invalid-password', 'iispasswordchangeinterval/invalidpassword/:username', 'IISPASSWORDCHANGEINTERVAL_CTRL_Iispasswordchangeinterval', 'invalidPassword'));
...
OW::getRouter()->addRoute(new OW_Route('iispasswordchangeinterval.resend-link-generate-token', 'iispasswordchangeinterval/resendlLinkGenerateToken/:username', 'IISPASSWORDCHANGEINTERVAL_CTRL_Iispasswordchangeinterval', 'resendlLinkGenerateToken'));
...
OW::getRouter()->addRoute(new OW_Route('iispasswordchangeinterval.change-user-password-with-username', 'iispasswordchangeinterval/changeuserpasswordwithusername/:username', 'IISPASSWORDCHANGEINTERVAL_CTRL_Iispasswordchangeinterval', 'changeUserPasswordWithUsername'));
