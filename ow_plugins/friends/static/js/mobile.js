var OWM_FriendsConsole = function( params )
{
    ...
    $("a.owm_friend_request_accept").on("click", function(){
        $(this).html('<span class="owm_preloader_circle" style="width: 14px;"><span></span></span>');
        self.consoleAcceptRequest($(this));
    });
    $("a.owm_friend_request_ignore").on("click", function(){
        $(this).html('<span class="owm_preloader_circle" style="width: 14px;"><span></span></span>');
