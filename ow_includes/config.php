...
define('OW_URL_HOME', 'http://localhost/motoshub/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'zahra');
define('OW_DB_PASSWORD', 'RrpvKJ3R7MpDTs3l');
define('OW_DB_NAME', 'test');
...
define('OW_PASSWORD_SALT', 'INykoRAD1wuxYRyK');
