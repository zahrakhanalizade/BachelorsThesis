...
class BASE_CMP_SiteStatistic  extends OW_Component
{
    ...
    protected function getMonths($count)
    {
        ...
        for ($i = $count-1; $i >= 0; $i--)
        {
            ...
            $jalaliDate = OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_AFTER_DEFAULT_DATE_VALUE_SET, array('changeTojalali' => true, 'yearTochange' =>  (int) $tmpDateArray[0], 'monthTochange'=> (int) $tmpDateArray[1] ,'dayTochange'=> (int)$tmpDateArray[2], 'monthWordFormat' =>true)));
